...
namespace CustomControls.RJControls
{
    public class RJDatePicker : DateTimePicker
    {
        ...
        private Image calendarIcon = RegisterLibVin.Properties.Resources.calendarWhite;
        ...
        public Color SkinColor
        {
            ...
            set
            {
                ...
                if (skinColor.GetBrightness() >= 0.6F)
                    calendarIcon = RegisterLibVin.Properties.Resources.calendarDark;
                else calendarIcon = RegisterLibVin.Properties.Resources.calendarWhite;
                this.Invalidate();
            }
        }
