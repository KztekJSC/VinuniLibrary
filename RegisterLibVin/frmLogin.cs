...
namespace RegisterLibVin
{
    public partial class frmLogin : Form
    {
        ...
        {
            //txbAcount.Texts = "spAdmin";
            //txbPass.Texts = "kienpino99";
        ...
        private void btnLogin_Click(object sender, EventArgs e)
        {
            try
            {
                ...
                {
                    // Nếu là đăng ký
                    LogHelper.LogUser("Page Login","Người dùng đăng ký", Application.StartupPath);
                    if (txbAcount.Texts != "" && txbPass.Texts != "" && txbPass2.Texts != "" && txbFullName.Texts != "")
                    {
                        if (txbPass2.Texts == txbPass.Texts)
                        {
                            ...
                            else
                            {
                                ...
                                if (result == DialogResult.Yes)
                                {
                                    ...
                                    string quyen = "User";
                                    string query = $"use VinUniver; insert into tblUser values ('{id}',N'{txbFullName.Texts}','{Filter(txbAcount.Texts)}','{Filter(txbPass.Texts)}','{quyen}', '0','0')";
                                    if (ConnectSQL.dbConnection.ExecuteCommand(query))
                                    {
                                        RJMessageBox.Show("Đăng ký thành công!", "Notice", MessageBoxButtons.OKCancel);
                                        LogHelper.LogUser("Page Login", $"Đăng ký thành công với FullName: {txbFullName.Texts}", Application.StartupPath);
                                    }
                                }
                            }
                        }
                        else
                        {
                            ...
                            LogHelper.LogUser("Page Login", $"Người dùng đăng ký nhập mật khẩu chưa trùng khớp", Application.StartupPath);
                ...
                else   // Nếu là đăng nhập
                {
                    ...
                    LogHelper.LogUser("Page Login", "Người dùng nhấn đăng nhập", Application.StartupPath);
                    ...
                    else
                    {
                        ...
                        if (dtLogin != null && dtLogin.Rows.Count > 0)
                        {
                            ...
                            if (Lock == false)
                            {
                                ...
                                f.Show();
                                //this.DialogResult = DialogResult.OK;
                                LogHelper.LogUser("Page Login", $"Đăng nhập thành công UserName: {txbAcount.Texts}", Application.StartupPath);
                            }
                            else
                            {
                        ...
                        else
                        {
                            ...
                            LogHelper.LogUser("Page Login", "Người dùng đăng nhập thất bại", Application.StartupPath);
            ...
            catch(Exception ex)
            {
                ...
                LogHelper.LogUser("Page Login", $"Lỗi hệ thống: {ex}", Application.StartupPath);
            }
        }
        ...
        {
            this.Close();
            LogHelper.LogUser("Page Login","Người dùng Exit", Application.StartupPath);
        ...
        private void togbtnRegister_Click(object sender, EventArgs e)
        {
            ...
            togbtnRegister.BackColor = Color.FromArgb(44, 59, 86);
        ...
        private void togbtnLogin_Click(object sender, EventArgs e)
        {
            ...
            togbtnLogin.BackColor = Color.FromArgb(44, 59, 86);
        ...
        private void txbAcount__TextChanged(object sender, EventArgs e)
        {
